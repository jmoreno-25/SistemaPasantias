...
@Component({
  selector: 'app-docente-postulaciones',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './docente-postulaciones.component.html',
  styleUrl: './docente-postulaciones.component.css'
})
export class DocentePostulacionesComponent implements OnInit {
